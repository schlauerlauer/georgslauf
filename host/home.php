...
<div class="ui-grid-b ui-responsive">
  ...
  <div class="ui-block-a host" host="fill0"><input data-icon="edit" data-theme="b" style="background:red;" value="Alle Punkte zurücksetzen" type="button"></div>
  <div class="ui-block-b host" host="deletePoints"><input data-icon="forbidden" style="background:red;" data-theme="b" value="Alle Punkte löschen" type="button"></div>
...
<div data-role="footer" data-tap-toggle="false" style="overflow:hidden; margin: 0px;">
		<h2><img src="/res/logo.png" style="max-height:100px;"/></h2>
	</div>
<?php endif; ?>
