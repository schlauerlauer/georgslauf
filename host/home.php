...
<div class="ui-grid-b ui-responsive">
  ...
  <div class="ui-block-b host" host="gruppenPunkte"><input data-icon="arrow-l" data-theme="a" value="Gruppen Punkte eintragen" type="button"></div>
  <div class="ui-block-c host" host="writeToPosten"><input data-icon="comment" data-theme="a" value="Posten Whatsapp" type="button"></div>
  ...
  <div class="ui-block-c host" host="setPLocation"><input data-icon="location" data-theme="a" value="Posten Positionen" type="button"></div>
  <div class="ui-block-a host" host="editLogins"><input data-icon="check" data-theme="a" value="Login Passwörter" type="button"></div>
  <div class="ui-block-b host" host="antiCheat"><input data-icon="eye" data-theme="a" value="Wächterwanze" type="button"></div>
  ...
  <div class="ui-block-c host" host="postenTop"><input data-icon="star" data-theme="b" value="Postentabelle" type="button"></div>
  <div class="ui-block-a host" host="gruppenTop"><input data-icon="star" data-theme="b" value="Gruppentabelle" type="button"></div>
  <div class="ui-block-b host" host="fill0"><input data-icon="edit" data-theme="b" value="Fülle Punkte" type="button"></div>
  <div class="ui-block-c host" host="deletePoints"><input data-icon="forbidden" data-theme="b" value="Lösche ALLE Punkte" type="button"></div>
  <div class="ui-block-a host" host="backupPunkte"><input data-icon="arrow-d" data-theme="b" value="Punkte Backup erstellen" type="button"></div>
  <div class="ui-block-b host" host="query"><input data-icon="grid" data-theme="b" value="Query" type="button"></div>
  ...
  <div class="ui-block-a host" host="gruppenGröße"><input data-icon="plus" disabled data-theme="a" value="Gruppengröße" type="button"></div>
