...
<div class="ui-grid-b ui-responsive">
  ...
  <div class="ui-block-c confirm" host="deleteAll"><input style="background:red;" data-icon="forbidden" data-theme="b" value="Alle Posten und Gruppen löschen" type="button"></div>
</div>
<h3>Punkte</h3>
<div class="ui-grid-b ui-responsive">
  ...
  <div class="ui-block-b confirm" host="fill0"><input data-icon="forbidden" data-theme="b" style="background:red;" value="Punktetabelle mit Nullen füllen" type="button"></div>
...
<div class="ui-grid-b ui-responsive">
  ...
  <div class="ui-block-c host" host="presentation"><input data-icon="arrow-d" data-theme="b" value="Erstelle HedgeDoc Präsentation" type="button"></div>
