...
<body>
	<div data-role="page" data-theme="b" id="georgslauf">
		<div data-role="header" data-position="fixed" data-tap-toggle="false" align="center">
			...
			<tr>
				<td style="width:5%;" align="center"><img src="../res/logo.png" style="max-height:70px;"/></td>
				<td style="width:90%;">
					<div data-role="navbar" id="menu">
						<ul>
							<li><a target="home.php" class="link ui-btn-active" style="height:30px; text-shadow:none;">Hostseite</a></li>
							<li><a target="gruppen.php" class="link" style="height:30px; text-shadow:none;">Gruppen</a></li>
							<li><a target="posten.php" class="link" style="height:30px; text-shadow:none;">Posten</a></li>
						</ul>
					</div>
				</td>
			</tr>
